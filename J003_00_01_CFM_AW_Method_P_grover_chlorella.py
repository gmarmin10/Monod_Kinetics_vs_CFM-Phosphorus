...
import random
import time
from matplotlib.pyplot import figure, xlim,ylim, xlabel, ylabel, plot, show, stackplot,legend
from sf import *
...
PO4 = data[3] #(uM) PO4 concentration
Mu_d = data[4]  #(d-1) Growth rate
