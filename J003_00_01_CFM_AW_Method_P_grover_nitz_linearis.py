...
PO4 = data[21] #(uM) PO4 concentration
Mu_d = data[22]  #(d-1) Growth rate
...
# Initial values
aP = 0.05*Qc/86400  #aPO4 #(mol N cell-1 s-1 / umolN L-1) affinity of PO4 (initial value from d007_06_00)
