...
import random 
import time
from matplotlib.pyplot import plot, figure, show, xlabel, ylabel, stackplot,ylimfrom sf import *
...
I=30    #(umolE m-2 s-1) light intensity
...
#OOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO
data = genfromtxt("ghaffar_data.csv",delimiter=',').T
...
# Initial values
aP = 0.1*Qc/86400  #aPO4 #(mol N cell-1 s-1 / umolN L-1) affinity of PO4 (initial value from d007_06_00)
Yn = 2.5*3.56099164557551  #Ynphoto_chl     #((molN cell-1)/(molC chl cell-1)) the stoichiometric ratio for cell photosynthetic enzyme (Rubisco etc.) nitrogen to chlorophyll (193-25)
Yn = 20
#Array preparation
