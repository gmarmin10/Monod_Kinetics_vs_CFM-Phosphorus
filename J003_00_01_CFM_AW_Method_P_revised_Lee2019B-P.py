...
import random
import timefrom matplotlib.pyplot import figure, plot, xlim,ylim, xlabel, ylabel, show
...
#OOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO
data = genfromtxt("Lee2019B-P.csv",delimiter=',').T
